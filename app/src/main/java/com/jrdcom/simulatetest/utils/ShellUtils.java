...
public class ShellUtils {
    ...
    public static CommandResult execCommand(String[] commands, boolean isRoot, boolean isNeedResultMsg) {
        Log.d(TAG, "execCommand isRoot:" + isRoot + ", isNeedResultMsg:" + isNeedResultMsg);
        int result = -1;
        ...
        try {
            ...
            //e.printStackTrace();
            Log.d(TAG, "execCommand IOException:" + e.toString());
        } catch (Exception e) {
            //e.printStackTrace();
            Log.d(TAG, "execCommand Exception:" + e.toString());
        } finally {
            try {
                if (os != null) {
                    os.close();
    ...
    public static class CommandResult {
        ...
        public String toString() {
            return super.toString() + "-- result:" + result + "," + successMsg + "," + errorMsg;
        }
    }
}
